...
public final class Constants {
    ...
    public static final class AutoConstants {
        public static final double xSpeed = -0.3; // Drive forward with negative Y (forward)
        public static final double ySpeed = 0.1; // Drive left with negative X (left)
        public static final double AutoRunTime = 1.5; // Drive counterclockwise with negative X (left)
    }
